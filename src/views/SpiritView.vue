      ...
      <div class="h-[93vh] max-md:h-full flex flex-col">
        <div class="flex-1 bg-[#f2d556] flex flex-col justify-between">
          <div class="flex pt-20 max-md:pb-10 flex-col p-4">
            <span class="uppercase font-light text-lg">Spirits</span>
            <span class="text-4xl font-light leading-10 max-md:text-2xl max-md:leading-8">
              The art of <b class="font-light italic">distillation</b> transforms the essence of our <b class="font-light italic">terroir</b> into liquid poetry. Each <b class="font-light italic">spirit</b> captures the soul of its origin, distilling centuries of tradition and craftsmanship into every precious drop that speaks of our <b class="font-light italic">heritage</b>
            </span>
          </div>
          <RegionMap 
      ...
      <div class="h-[93vh] max-md:h-96 relative overflow-hidden flex items-center justify-center">
        ...
        >
          ...
          >
            ...
            <img 
              :src="region.products.spirits[0]?.bottleImage"
              :alt="region.name"
